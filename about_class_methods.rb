...
class AboutClassMethods < Neo::Koan
  ...
  # Ans: I prefer the self.method way because it clearly shows that #method
  #      is added to self. class << self opens the Demo's singleton class
  #      and adds a static method to Demo class.
  #
  # Are there times you might prefer one over the other?
  # Ans: singleton class is often used for holding methods for a particular
  #      instance of a class. It is less clear in the context of static class method.
  # obj = Object.new
  # class << obj
  #   def obj_method
  #   end
