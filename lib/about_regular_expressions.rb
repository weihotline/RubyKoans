...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Ans: Considering the test case `/z*/` above, it will never fail
    # because * is greedy (anything would be fine).
  end
  ...
  # Ans: a character class: matching single character
  #      alternation: match everything to the left of the vertical bar
  #                   or the right of the vertical bar (e.g., James|Dana): James or Dana
