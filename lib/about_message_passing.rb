...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Ans: #send could be overridden for other functionalities.
    #      To be safe, __send__ is provided and should never be overridden.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Ans: If we redefine method_missing, then it wouldn't cause NoMethodError,
