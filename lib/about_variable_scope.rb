...
class AboutVariableScope < Neo::Koan
  ...
  # Ans: Each instance of a class has its own copy of a instance variable.
  #      All instances of a class share the class variable.
...
# Ans: It is a global variable. So $anywhere can be accessed outside
#      of the scope of where it is declared.
#      $anyhwere is "Hey" down here.
