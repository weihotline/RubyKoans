...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Ans: += operator is a shorthand for A = A + B. It creates a new string
    # by copying A and concatenating A and B, and then assigns it back to A
    # << operator alters the original string A (no needs to create a new string)
    # (less memory usage, less garbage collection)
  end
