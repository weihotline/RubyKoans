...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # Ans: when #new method of the class is called, it executes
    #      the initialize method with parameters. In the above case,
    #      #initialize accepts one argument, hence calling Dog6.new with
    #      no arguments raises ArgumentError.
  end
